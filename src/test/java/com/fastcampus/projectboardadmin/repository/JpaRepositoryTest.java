...
class JpaRepositoryTest {
    ...
    void givenUserAccount_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = UserAccount.of("test", "pw", Set.of(RoleType.USER), null, null, null, null);
    ...
    void givenUserAccountAndRoleType_whenUpdating_thenWorksFine() {
        // Given
        UserAccount userAccount = userAccountRepository.getReferenceById("uno");    // ADMIN 권한만 있는 상태
